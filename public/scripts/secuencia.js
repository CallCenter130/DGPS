document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        formStatus.textContent = ''; // Limpiamos mensajes anteriores

        // La clave de sitio PÚBLICA de reCAPTCHA
        const recaptchaSiteKey = '6Lfb6bwrAAAAAGwHL3PsiifhI2gko8a_Ad0xdrV9';
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute(recaptchaSiteKey, { action: 'submit' }).then(function(token) {
                ...
                // Ya tenemos el token de reCAPTCHA, ahora preparamos el envío
